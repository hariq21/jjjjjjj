...
import { createQrisPayment } from "@/lib/duitku"; // sudah pakai alias @
  ...
  const handleQris = async (diamond: any) => {
    ...
    try {
      ...
      if (result?.paymentUrl) {
        // ✅ Langsung redirect ke halaman topup Duitku
        window.location.href = result.paymentUrl;
      } else {
        alert("Gagal membuat pembayaran QRIS: " + JSON.stringify(result));
      }
    } catch (err) {
